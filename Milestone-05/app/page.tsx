  ...
  return (
    <div className="min-h-screen bg-slate-200 p-8 ">
      <div className="max-w-4xl mx-auto bg-gradient-to-r from-blue-300 to-purple-200 shadow-lg rounded-lg p-8 ">
        <h1 className="text-4xl font-bold text-center text-gray-800 mb-8 bg-yellow-400 mx-40 rounded-xl print:hidden">Professional Resume Builder</h1>

        
        <form className="space-y-8 print:hidden" onSubmit={generateResume}>
          <input
            type="text"
            placeholder="Enter your username"
            value={username}
            onChange={(e) => setUsername(e.target.value)}
            className="text-xl block w-full p-2 rounded"
            required
          />
        ...
        {resume && (
          <div className="mt-10 p-8 max-w-3xl mx-auto border-2 border-gray-300 rounded-lg bg-gradient-to-r from-blue-900 to-indigo-500 shadow-xl text-center" id="resumeOutput">
            ...
            <div className="space-y-6 text-left max-w-2xl mx-auto text-slate-200">
              ...
              <div className="py-4 border-t border-b border-gray-300">
                ...
                <p className="text-lg text-white break-words whitespace-pre-line">{resume.education}</p>
              </div>
              <div className="py-4 border-b border-gray-300">
                <h3 className="text-2xl font-bold text-yellow-500 mb-2">Work Experience</h3>
                <p className="text-lg text-white break-words whitespace-pre-line">{resume.experience}</p>
              </div>
              <div className="py-4 border-b border-gray-300">
        ...
        <div className="mt-8 flex justify-center space-x-4 print:hidden">
          <button
            ...
            className="py-2 px-4 bg-green-600 text-white font-semibold rounded-md hover:bg-green-700 transition-colors"
          >
              Download as PDF
